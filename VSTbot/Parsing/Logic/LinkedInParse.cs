...
{
    public class LinkedInParse : IParse
    {
        ...
        public IEnumerable<Vacancy> GetVacancies(string siteName, string paramString)
        {
            throw new NotImplementedException();
        }
        ...
        public string InputData(string siteName, string paramString)
        {
            throw new NotImplementedException();
        }
